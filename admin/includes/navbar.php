<nav class="navbar navbar-expand-lg bg-light shadow-sm p-3 mb-5 bg-body rounded">
  <div class="container-fluid">
    <a class="navbar-brand" href="<?php echo $rootPath; ?>">
        <img src="<?php echo $rootPath?>/assets/img/T_Coffee.png" alt="Logo" width="80" height="50" class="d-inline-block align-text-top">
    </a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item">
            <a class="nav-link" href="<?php echo $rootPath?>/report.php">Thông kê</a>
          </li>
      ...
      <form class="d-flex me-3" role="search">
        ...
        <button class="btn btn-warning round-circle" type="submit">
