    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-4 pt-5">
                <h2 class="h2 text-warning border-bottom pb-3 border-light logo user-select-none">Shop</h2>
            ...
            <div class="col-md-4 pt-5">
                ...
                <ul class="list-unstyled text-light footer-link-list">
                    ...
                    <li><a class="text-decoration-none text-light primary-item" href="#">Gửi yêu cầu bảo hành</a></li>
                    <li><a class="text-decoration-none text-light primary-item" href="#">Góp ý, khiếu nại</a></li>
                </ul>
            </div>
            ...
            <div class="col-md-4 pt-5">
                ...
                <ul class="list-unstyled text-light footer-link-list">
                    ...
                    <li><a class="text-decoration-none text-light primary-item" href="#">Chính sách bảo hành</a></li>
                </ul>
            </div>
